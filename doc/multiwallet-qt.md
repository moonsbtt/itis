...
In order to support loading of multiple wallets in itis-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is itis.cpp.
...
Changes to itis.cpp
----------------------
itis.cpp is the entry point into itis-qt, and as such, will require some minor modifications to provide hooks for
