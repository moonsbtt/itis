                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ITIS-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ITIS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and itis: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ITIS.Network"), this);
    aboutAction->setStatusTip(tr("Show information about ITIS.Network"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ITIS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ITIS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ITIS addresses"));
    ...
    openAction->setStatusTip(tr("Open a ITIS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ITIS.Network help message to get a list with possible ITIS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ITIS.Network client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ITIS network", "", count));
}
...
{
    QString strTitle = tr("ITIS.Network"); // default title
