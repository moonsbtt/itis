...
RESOURCES += src/qt/itis.qrc src/qt/itis_locale.qrc

TRANSLATIONS += src/qt/locale/itis_bg.ts \
                src/qt/locale/itis_de.ts \
                src/qt/locale/itis_en.ts \
                src/qt/locale/itis_es.ts \
                src/qt/locale/itis_fi.ts \
                src/qt/locale/itis_fr.ts \
                src/qt/locale/itis_it.ts \
                src/qt/locale/itis_ja.ts \
                src/qt/locale/itis_pl.ts \
                src/qt/locale/itis_pt.ts \
                src/qt/locale/itis_ru.ts \
                src/qt/locale/itis_sk.ts \
                src/qt/locale/itis_sv.ts \
                src/qt/locale/itis_vi.ts \
                src/qt/locale/itis_zh_CN.ts \
                src/qt/locale/itis_zh_TW.ts
